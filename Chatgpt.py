...
def MainExecutionChatGPT():
    ...
    while True:
        ...
        try:
            File = open("DataBase\listen.txt","r")
            Data = File.read()
            File.close()
            FileHistory = open("DataBase\chat_History.txt","r")
            ...
            if str(Data)==str(DataHistory):
                ...
                FileHistory = open("DataBase\chat_History.txt","w")
